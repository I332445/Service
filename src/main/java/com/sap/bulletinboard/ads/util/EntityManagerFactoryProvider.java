...
public class EntityManagerFactoryProvider {
    ...
    /**
     * Set some basic properties. In our case the database schema is created (or extended) automatically.
     * Find more properties under org.eclipse.persistence.config.PersistenceUnitProperties
     */
